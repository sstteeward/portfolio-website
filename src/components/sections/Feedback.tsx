      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid lg:grid-cols-[1.1fr_1.5fr] gap-10 items-start">
          ...
          <motion.div
            ...
            className="rounded-3xl border border-white/10 bg-[#0A0A0A] p-6 md:p-8 shadow-2xl relative overflow-hidden"
          >
                ...
                <AnimatePresence initial={false}>
                  {feedbacks.map((entry) => (
                    <motion.div
                      ...
                      className="group border border-white/5 bg-white/[0.02] backdrop-blur-md rounded-2xl p-5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 shadow-md flex gap-4"
                    >
                      <div
